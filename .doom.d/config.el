...
;;List of keybindings (SPC h b b)")
  (setq dashboard-banner-logo-title "EMACS: Eight Megabytes And Constantly Swapping")
  ;;(setq dashboard-startup-banner 'logo) ;; use standard emacs logo as banner
  (setq dashboard-startup-banner "~/.doom.d/dragonite.png")  ;; use custom image as banner
